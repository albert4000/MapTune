...
temp_blif = os.path.join("temp_blifs", f"{circuit_name}_bs_ep_temp.blif")
...
def technology_mapper(genlib_origin, partial_cell_library):
    ...
    output_genlib_file = os.path.join(lib_path, f"{design_basename}_{len(lines_partial)}_bs_ep_samplelib.genlib")
